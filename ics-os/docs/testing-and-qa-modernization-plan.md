...
| Networking | `test-net`, `test-net-unit` | virtio-net MSI-X attach, static SLIRP config, ARP + ICMP echo to `10.0.2.2`; host TAP for checksum/ARP/ICMP | No UDP/TCP/sockets/DHCP; single interface; no flood/reset stress |

...
strcpy(mymalloc.hdr.name,"dl_malloc");
strcpy(mymalloc.hdr.description,"Doug Lea's dlmalloc VERSION 2.7.2");
mymalloc.malloc  = dlmalloc;
mymalloc.realloc = dlrealloc;
mymalloc.free    = dlfree;
